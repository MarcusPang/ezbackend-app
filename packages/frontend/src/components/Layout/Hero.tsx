    ...
    <div className="hero min-h-screen bg-base-100">
      <div className="text-center hero-content">
        <div className="max-w-md">
          ...
          <p className="mb-3">Welcome to an EzBackend sample app!</p>
          <p className="mb-5">
            Log in with a Google account at the top right to get started
          </p>
          <Link href="https://github.com/marcuspang/ezbackend-app" passHref>
